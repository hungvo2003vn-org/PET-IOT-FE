...
import EatHistoryModal from './EatHistoryModal';
import WeightModal from './WeightModal';
import OverallStatusModal from './OverallStatusModal';
import NoteLogsModal from './NoteLogsModal';
        ...
        <View style={styles.cardContainer}>
            ...
            <Card style={styles.card}>
                <Card.Content style={styles.cardContent}>
                    ...
                    {/* Eat history */}
                    <View style={styles.cardList}>
                        <Text style={styles.cardSetting}>Eat history</Text>
                    ...
                    {/* Note logs */}
                    <View style={styles.cardList}>
                        <Text style={styles.cardSetting}>Note logs</Text>
